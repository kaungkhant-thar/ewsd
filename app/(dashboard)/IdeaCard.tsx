...
export default function IdeaCard({
  ...
  const handleCardClick = (e: React.MouseEvent) => {
    ...
    console.log((e.target as HTMLElement).closest('[role="button"]'))
    if (
  ...
  return (
    <>
      <div onClick={handleCardClick}>
        <Card ref={cardRef} className="mx-auto bg-[#F9FBFD] border border-[#D1D9E2] hover:shadow-md transition-shadow cursor-pointer">
                ...
                {ideaDocuments.map(({ id, publicFileUrl }) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div role="button" className="absolute top-1.5 right-1.5 flex space-x-1 z-10 ">
                        <a
